...
import type { Sponsorship as _Sponsorship, SponsorshipTier as _SponsorshipTier, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllSponsorships(): Promise<Array<Sponsorship>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSponsorships();
    ...
    async getTopDonors(): Promise<Array<Donation>> {
        if (this.processError) {
            try {
    ...
    async submitDonation(arg0: Donation): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDonation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSponsorship(arg0: Sponsorship): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSponsorship(to_candid_Sponsorship_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateNotificationEmail(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNotificationEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_SponsorshipTier_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SponsorshipTier): SponsorshipTier {
    return from_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function from_candid_Sponsorship_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Sponsorship): Sponsorship {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        tier: from_candid_SponsorshipTier_n13(_uploadFile, _downloadFile, value.tier),
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bronze" in value ? SponsorshipTier.bronze : "gold" in value ? SponsorshipTier.gold : "silver" in value ? SponsorshipTier.silver : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Sponsorship>): Array<Sponsorship> {
    return value.map((x)=>from_candid_Sponsorship_n11(_uploadFile, _downloadFile, x));
}
function to_candid_SponsorshipTier_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SponsorshipTier): _SponsorshipTier {
    return to_candid_variant_n21(_uploadFile, _downloadFile, value);
}
function to_candid_Sponsorship_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Sponsorship): _Sponsorship {
...
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        designation: value.designation,
        tier: to_candid_SponsorshipTier_n20(_uploadFile, _downloadFile, value.tier),
        contactPerson: value.contactPerson,
        email: value.email,
        timestamp: value.timestamp,
        companyName: value.companyName,
...
function to_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SponsorshipTier): {
    bronze: null;
} | {
    gold: null;
} | {
    ...
    return value == SponsorshipTier.bronze ? {
        bronze: null
    } : value == SponsorshipTier.gold ? {
        gold: null
    } : value == SponsorshipTier.silver ? {
        silver: null
    } : value;
}
